 ...
 */
public class TabLayoutPlace  extends LinearLayout {
    ...
    public TabLayoutPlace(Context context) {
        this(context, null);
    }

    public TabLayoutPlace(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabLayoutPlace(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setOrientation(HORIZONTAL);
        inflate(context, R.layout.layout_tab_place, this);
