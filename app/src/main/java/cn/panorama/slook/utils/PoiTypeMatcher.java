...
import cn.panorama.slook.model.PoiType;
...
public class PoiTypeMatcher {
	...
	private static void initIconMatcher() {
		iconMatcher.put("美食", new Icon(R.mipmap.ic_map_food,
				R.drawable.shaper_ar_marker_btn_rect));
		iconMatcher.put("酒店", new Icon(R.mipmap.ic_map_hotel,
				R.drawable.shaper_ar_marker_btn_rect_b));
		iconMatcher.put("银行", new Icon(R.mipmap.ic_map_bank,
				R.drawable.shaper_ar_marker_btn_rect_b));
		iconMatcher.put("娱乐", new Icon(R.mipmap.ic_map_ktv,
				R.drawable.shaper_ar_marker_btn_rect));
		iconMatcher.put("商场", new Icon(R.mipmap.ic_map_market,
				R.drawable.shaper_ar_marker_btn_rect));
		iconMatcher.put("景点", new Icon(R.mipmap.ic_map_viewspot,
				R.drawable.shaper_ar_marker_btn_rect_b));
		iconMatcher.put("厕所", new Icon(R.mipmap.ic_map_wc,
				R.drawable.shaper_ar_marker_btn_rect_b));
		iconMatcher.put("公交站", new Icon(R.mipmap.ic_map_bus,
				R.drawable.shaper_ar_marker_btn_rect_b));
	}
	...
	public static Icon getPoiIcon(String lableName) {
		...
		if (null == icon)
			return new Icon(R.mipmap.ic_map_like,
					R.drawable.shaper_ar_marker_btn_rect);
		return icon;
	}
}