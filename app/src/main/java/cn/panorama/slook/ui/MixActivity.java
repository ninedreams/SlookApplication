...
import cn.panorama.slook.control.AMapController;
import cn.panorama.slook.control.AMapController.AMapStatus;
import cn.panorama.slook.control.AMapController.AMapStatusLinstener;
...
import cn.panorama.slook.utils.AnimationFactory;
...
import cn.panorama.slook.view.ARMarkerDialog;
import cn.panorama.slook.view.ARMarkerDialog.onNaviListener;
import cn.panorama.slook.view.ArcMenu;
import cn.panorama.slook.view.ArcMenu.OnMenuItemClickListener;
...
import cn.panorama.slook.view.LayerDialog;
import cn.panorama.slook.view.LayerDialog.Layer;
import cn.panorama.slook.view.LayerDialog.OnLayerChangedListener;
import cn.panorama.slook.view.MInfowindow;
import cn.panorama.slook.view.MInfowindow.onInfowindowClickedLinstener;
import cn.pedant.SweetAlert.SweetAlertDialog;
import cn.pedant.SweetAlert.SweetAlertDialog.OnSweetClickListener;
import cn.pedant.SweetAlert.SweetAlertDialog.OnSweetSeekBarChangeListener;

import static cn.panorama.slook.Constants.EVENT_ACTIVITY_START_AR_NAVI;
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_START_OFFLINEMAP;
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_START_USER_DEFINED_POINT;
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_START_WEATHER;
import static cn.panorama.slook.Constants.EVENT_AR_INFOWINDOW_ARISE;
import static cn.panorama.slook.Constants.EVENT_BOTTOM_DIALOG_SHOW;
import static cn.panorama.slook.Constants.EVENT_MAP_ZOOM_IN;
import static cn.panorama.slook.Constants.EVENT_MAP_ZOOM_OUT;
import static cn.panorama.slook.Constants.EVENT_SEARCH_POI;
import static cn.panorama.slook.Constants.EVENT_SEEKDIALOG_PUSH;
...
public class MixActivity extends ARActivity implements OnClickListener,
		APoiSearchListener, OnSweetClickListener,
	...
	static class MHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case EVENT_SEEKDIALOG_PUSH:
				...
				dialog.setOnSweetSeekBarChangeListener((OnSweetSeekBarChangeListener) mActivity.get());
				dialog.show();
	...
	public void onLayerChanged(Layer layer) {
		...
		switch (layer) {
		case AMAP_POI:
			mLayerBtn.setImageResource(R.mipmap.ic_map_layer_amap);
			...
			break;
		case USER_POI:
			mLayerBtn.setImageResource(R.mipmap.ic_map_layer_user);
			...
			break;
		case MIX_POI:
			mLayerBtn.setImageResource(R.mipmap.ic_map_layer_mix);
			if (mMapController.isNullPoiOverlay())
				mMapController.addPoiOverlay(mPoiSearchData.getPois());
			if (mMapController.isNullUserDefineMarkers()) {
				mGeoPointList = mGeoPointDao.fetchAllGeoPoints();
			...
			break;
		case NO_POI:
			mLayerBtn.setImageResource(R.mipmap.ic_map_layer);
			mMapController.removePoiOverlay();
			mMapController.removeUserDefineMarkers();
