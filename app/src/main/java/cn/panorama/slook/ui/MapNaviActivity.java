...
import cn.panorama.slook.control.AMapNaviController;
import cn.panorama.slook.control.AMapNaviController.OnNavingListener;
import cn.panorama.slook.utils.AnimationFactory;
import cn.panorama.slook.AppManager;
import cn.panorama.slook.utils.GeoCalcUtil;
import cn.panorama.slook.utils.TimerUtil;
import cn.panorama.slook.view.RippleLayout;
import cn.pedant.SweetAlert.SweetAlertDialog;
import cn.pedant.SweetAlert.SweetAlertDialog.OnSweetClickListener;

import static cn.panorama.slook.Constants.EVENT_ACTIVITY_FINISH_MAP_NAVI;
import static cn.panorama.slook.Constants.EVENT_NAVI_RECALCUL_ROUTE;
import static cn.panorama.slook.Constants.IS_DEBUG;
import static cn.panorama.slook.Constants.NAVI_MODE_EMULATOR;
import static cn.panorama.slook.Constants.NAVI_MODE_GPS;
...
public class MapNaviActivity extends SensorActivity implements OnClickListener,
	...
	private void initView() {
		...
		options.setEndPointBitmap(BitmapFactory.decodeResource(getResources(),
				R.mipmap.ic_map_target_2));
		options.setStartPointBitmap(BitmapFactory.decodeResource(
				getResources(), R.mipmap.ic_map_start_2));
	...
	public void onClick(View v) {
		...
		case R.id.id_imageView_navi_navBtn:
			...
			if (mMapNaviController.IsNaving()) {
				...
				mNaviBtn.setImageResource(R.mipmap.ic_toolbar_nav);
			} else {
				// 启动导航
				mMapNaviController.startNavi();
				mNaviBtn.setImageResource(R.mipmap.ic_toolbar_pause);
			}
			break;
	...
	public void onArriveDestination() {
		mNaviBtn.setImageResource(R.mipmap.ic_toolbar_nav);
		mTurnView.setImageResource(R.mipmap.ic_navi_destation);
	}
