...
import cn.panorama.slook.adapter.WeatherPagerAdapter;
import cn.panorama.slook.control.AMapQueryer;
import cn.panorama.slook.control.AMapQueryer.OnWeatherQueryListener;
...
import cn.panorama.slook.utils.WeatherUtil;
import cn.panorama.slook.view.CirclePageIndicator;
...
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_FINISH_WEATHER;
...
public class WeatherActivity extends OriginActivity implements OnClickListener,
	...
	private boolean isNull(String str) {
		return !(null != str && !"".equals(str.trim()) && !"N/A".equals(str.trim()));
	}
