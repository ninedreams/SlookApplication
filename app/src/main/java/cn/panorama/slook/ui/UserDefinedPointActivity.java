...
import cn.panorama.slook.control.AMapQueryer.OnMapQueryListener;
...
import cn.panorama.slook.view.MGeoPointInfowindow;
import cn.panorama.slook.view.MGeoPointInfowindow.onInfowindowClickedLinstener;
import cn.panorama.slook.view.MaterialMenuDrawable.IconState;
import cn.panorama.slook.view.MaterialMenuView;
import cn.panorama.slook.view.RippleLayout;
import cn.pedant.SweetAlert.SweetAlertDialog;

import static cn.panorama.slook.Constants.EVENT_ACTIVITY_FINISH_USER_DEFINED_POINT;
...
import static cn.panorama.slook.Constants.EVENT_USER_DEFINED_POINT_ADD;
import static cn.panorama.slook.Constants.EVENT_USER_DEFINED_POINT_DEL;
import static cn.panorama.slook.Constants.IS_DEBUG;
import static cn.panorama.slook.Constants.NO_RESULT;
import static cn.panorama.slook.Constants.TAB_USER_DEFINED_POINT_MARKER;
	...
	public void onClick(View v) {
		...
		case R.id.id_imageView_select:
			...
			if (mSelectMode.compareAndSet(false, true)) {
				iv.setImageResource(R.mipmap.ic_ar_del);
			} else {
				iv.setImageResource(R.mipmap.ic_geopoint_select);
