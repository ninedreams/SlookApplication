...
import cn.panorama.slook.view.IconEditText.OnIconClickedListener;
...
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_START_INDEX;
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_START_MAP_NAVI;
...
public class MapActivity extends OriginActivity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.id_imageView_labelBtn:
			...
			mArcMenu.toggle(500);
			if (mArcMenu.isOpen()) {
				mLabelBtn.setImageResource(R.mipmap.ic_toolbar_del);
			} else {
