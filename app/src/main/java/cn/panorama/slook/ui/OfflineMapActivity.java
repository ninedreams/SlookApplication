...
import cn.panorama.slook.adapter.OfflineMapAllCityListAdapter;
import cn.panorama.slook.adapter.OfflineMapCityListAdapter;
import cn.panorama.slook.adapter.OfflineMapDownloadCityListAdapter;
import cn.panorama.slook.adapter.OfflineMapHotRegionListAdapter;
import cn.panorama.slook.adapter.OfflineMapPagerAdapter;
import cn.panorama.slook.control.AOfflineMapManager;
import cn.panorama.slook.control.AOfflineMapManager.AOfflineMapDownloadListener;
...
import static cn.panorama.slook.Constants.EVENT_ACTIVITY_FINISH_OFFLINEMAP;
import static cn.panorama.slook.Constants.EVENT_OFFLINEMAP_DOWNLOAD;
import static cn.panorama.slook.Constants.EVENT_OFFLINEMAP_INIT_ADPATERS;
import static cn.panorama.slook.Constants.EVENT_OFFLINEMAP_UPDATE_ADPATERS;
import static cn.panorama.slook.Constants.EVENT_OFFLINEMAP_UPDATE_RELATED_CITY_ADPATER;
import static cn.panorama.slook.Constants.IS_DEBUG;
import static cn.panorama.slook.view.MaterialMenuDrawable.IconState;
...
public class OfflineMapActivity extends OriginActivity implements
	...
	private void changeContentPage(int position) {
		...
		case 0:
			mCityListBtn
					.setBackgroundResource(R.mipmap.ic_offlinearrow_tab1_pressed);
			mDownloadBtn
					.setBackgroundResource(R.mipmap.ic_offlinearrow_tab2_normal);
			break;
		case 1:
			mCityListBtn
					.setBackgroundResource(R.mipmap.ic_offlinearrow_tab1_normal);
			mDownloadBtn
					.setBackgroundResource(R.mipmap.ic_offlinearrow_tab2_pressed);
			break;
		}
