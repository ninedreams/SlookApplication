...
import static cn.panorama.slook.view.MaterialMenuDrawable.Stroke;
import static cn.panorama.slook.view.MaterialMenuDrawable.DEFAULT_COLOR;
import static cn.panorama.slook.view.MaterialMenuDrawable.DEFAULT_SCALE;
import static cn.panorama.slook.view.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static cn.panorama.slook.view.MaterialMenuDrawable.DEFAULT_VISIBLE;
	...
	private void init(Context context, AttributeSet attributeSet) {
		...
		try {
			int color = attr.getColor(R.styleable.MaterialMenuView_mm_color,
					DEFAULT_COLOR);
			boolean visible = attr.getBoolean(
					R.styleable.MaterialMenuView_mm_visible, DEFAULT_VISIBLE);
			float scale = attr.getFloat(R.styleable.MaterialMenuView_mm_scale,
					DEFAULT_SCALE);
